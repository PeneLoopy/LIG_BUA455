...
- Individual work:
   ...
   - **<span style="text-decoration:underline">[HW 5 - Part 2](https://rpubs.com/PeneLope_PE/900345)</span>** expands on prior dashboard assignment.
  ...
  - **Time permitting: additional 'Literate Programming' skills**
     ...
     - Using RStudio to create reports or slides (like this deck)
